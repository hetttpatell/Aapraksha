    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        switchMic.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked) {
                    Toast.makeText(NotificationSettingsActivity.this, "Microphone Permission Enabled", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(NotificationSettingsActivity.this, "Microphone Permission Disabled", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        switchCamera.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked) {
                    Toast.makeText(NotificationSettingsActivity.this, "Camera Permission Enabled", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(NotificationSettingsActivity.this, "Camera Permission Disabled", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        switchLocation.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked) {
                    Toast.makeText(NotificationSettingsActivity.this, "Location Permission Enabled", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(NotificationSettingsActivity.this, "Location Permission Disabled", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        switchCall.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked) {
                    Toast.makeText(NotificationSettingsActivity.this, "Call Permission Enabled", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(NotificationSettingsActivity.this, "Call Permission Disabled", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    private void setupBottomNav() {
        ...
        if (navHome != null) {
            navHome.setOnClickListener(v -> {
                Intent intent = new Intent(NotificationSettingsActivity.this, DashboardActivity.class);
